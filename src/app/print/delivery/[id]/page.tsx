...
export default async function PrintDeliveryPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", maxWidth: 760, margin: "0 auto", padding: "24px 32px", color: "#111" }}>
      ...
      {/* Header stripe */}
      <div style={{ background: "#1e3a5f", color: "white", padding: "14px 20px", borderRadius: "6px 6px 0 0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ fontWeight: 800, fontSize: 20, letterSpacing: "-0.01em" }}>DELIVERY RECEIPT</div>
          <div style={{ fontSize: 12, opacity: 0.75, marginTop: 2 }}>Packing List / Proof of Delivery</div>
        </div>
